...
$top_title = the_field('header_top_title');
$bottom_title = the_field('header_bottom_title');
$head_text =  the_field('header_text');
$check_offer = the_field('check_offer');
?>
			<div class="scrollBar">
                    ...
                    <div class="welcome__sliderBox welcome__sliderBox--active">
                        ...
                        <div class="welcome__textCont">
                            <h1 class="welcome__header">
                                <div class="welcome__withUnderline"><?php if( $top_title): ?> <?php $top_title =  the_field('header_top_title'); ?><?php endif; ?></div>
                                <span class="welcome__headerSub"><?php if( $bottom_title): ?><?php  $bottom_title = the_field('header_bottom_title'); ?><?php endif; ?></span>
                            </h1>
                            <div class="welcome__text">
                               <?php if( $head_text): ?><?php $head_text =  the_field('header_text'); ?><?php endif; ?>
                            </div>
                            <div class="welcome__linkCont">
                                <div class="linkWithArrow__cont">
                                    <a href="offer.html" class="linkWithArrow__text">
                                        <?php if( $check_offer): ?><?php $check_offer = the_field('check_offer'); ?><?php endif; ?>
                                    </a>
